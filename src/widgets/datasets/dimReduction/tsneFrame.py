...
class TSNEFrame(ctk.CTkScrollableFrame, EmbeddedScrollFrame):
    ...
    def __init__(self, master):
        ...
        # Perplexity
        self.labels.append(ctk.CTkLabel(self, text="Perplexity", wraplength=self.winfo_width()//2 - 20, justify="left", padx=10))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Number of iterations", wraplength=self.winfo_width()//2 - 20, justify="left", padx=10))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Maximun number of iterations without progress", wraplength=self.winfo_width()//2 - 20, justify="left", padx=10))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Initialization of embedding", wraplength=self.winfo_width()//2 - 20, justify="left", padx=10))
        ...
        # Method
        self.labels.append(ctk.CTkLabel(self, text="Method", wraplength=self.winfo_width()//2 - 20, justify="left", padx=10))
