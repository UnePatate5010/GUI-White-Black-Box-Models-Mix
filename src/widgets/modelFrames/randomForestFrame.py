...
class RandomForestFrame(ctk.CTkScrollableFrame, Model):
    ...
    def __init__(self, master):
        ...
        # Number of trees: 
        self.labels.append(ctk.CTkLabel(self, text="Number of trees", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Criterion", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Maximum depth", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Minimum split samples", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Minimum leaf samples", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Maximum number of features", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        self.labels.append(ctk.CTkLabel(self, text="Bootstrap", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        # Maximum number of features considered when splitting
        self.labels.append(ctk.CTkLabel(self, text="Maximum number of samples per tree", wraplength=self.winfo_width()//2 - 20, justify="left"))
