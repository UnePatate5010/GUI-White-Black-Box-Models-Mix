...
class SvmFrame(ctk.CTkScrollableFrame, Model):
    ...
    def __init__(self, master):
        ...
        self.labels.append(ctk.CTkLabel(self, text="Regularization parameter", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        # Kernel
        self.labels.append(ctk.CTkLabel(self, text="Kernel", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        # Degree
        self.labels.append(ctk.CTkLabel(self, text="Degree", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        # Kernel coefficient
        self.labels.append(ctk.CTkLabel(self, text="Kernel coefficient", wraplength=self.winfo_width()//2 - 20, justify="left"))
        ...
        # Maximum iteration
        self.labels.append(ctk.CTkLabel(self, text="Maximum iteration", wraplength=self.winfo_width()//2 - 20, justify="left"))
